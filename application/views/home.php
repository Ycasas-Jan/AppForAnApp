...
<section id="banner">
    ...
    <p>A new way to book appointments!</p>
    <ul class="actions">
        <li><a href="./demo" class="button big special">Book An Appointment Now</a></li>
    </ul>
</section>
...
<section id="two" class="wrapper special">
    <div class="inner">
        <header class="major narrow">
            <h2>Companies that use AppForAnApp</h2>
        </header>
        ...
        <ul class="actions">
            <li><a href="#" class="button big alt">More Info</a></li>
        </ul>
    </div>
</section>
